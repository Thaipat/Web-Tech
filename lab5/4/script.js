...
function ExtractData(data) {
    document.write(`<body><div style="display:flex;justify-content:center;align-items:center;margin-top:11%">`)
    for (let i = 0; i < data.movies.showing.length; i++) {
        ...
        <img src="${data.movies.showing[i].poster}" style="width:150px;position:absolute;top:-10%;left:14%">\
